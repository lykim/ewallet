...
public class UserTopTransactionTest extends BaseStoriesTest{
	...
	public void givenToken_thenReturnResultDesc() {
		...
		assertEquals(-500000,  topTransactions[0].amount);
		assertEquals(registerUser3, topTransactions[0].username);
		assertEquals(500000, topTransactions[1].amount);
		assertEquals(registerUser4, topTransactions[1].username);
		assertEquals(-400000, topTransactions[2].amount);
		assertEquals(registerUser2, topTransactions[2].username);
		assertEquals(-300000, topTransactions[3].amount);
		assertEquals(registerUser1, topTransactions[3].username);
//		assertEquals(500000, topTransactions[0].amount);
//		assertEquals(registerUser4, topTransactions[0].username);
//		assertEquals(-400000, topTransactions[1].amount);
//		assertEquals(registerUser2, topTransactions[1].username);
//		assertEquals(-300000, topTransactions[2].amount);
//		assertEquals(registerUser1, topTransactions[2].username);
//		assertEquals(200000, topTransactions[3].amount);
//		assertEquals(registerUser3, topTransactions[3].username);
	}
